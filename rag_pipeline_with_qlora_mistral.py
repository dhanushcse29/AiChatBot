...
ADAPTER_PATH = r"D:/Interns/pdf_extraction_using_chromadb/models/mistral_qlora_adapters"
...
def build_prompt(context: str, question: str, qtype: str) -> str:
    """Build Mistral-format prompt with context and question"""
    style_map = {
    ...
    return f"""[INST]
You are a technical assistant specializing in EW systems.
...
print(f"\n✅ RAG READY — {model_type} Mistral Model, ChromaDB Backend, Offline, GPU-Accelerated\n")
